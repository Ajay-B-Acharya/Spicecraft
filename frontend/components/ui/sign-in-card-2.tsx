              ...
              <form onSubmit={handleSubmit} className="relative space-y-4">
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="text-xs">
                    <Link href="/forgot-password" className="text-white/60 transition-colors duration-200 hover:text-white">
                      Forgot password?
                    </Link>
                  </div>
                </div>
                ...
                >
                  {alternateLabel}{' '}
                  <Link href={alternateHref} className="group/signup relative inline-block">
